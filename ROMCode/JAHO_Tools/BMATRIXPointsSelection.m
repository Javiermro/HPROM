function  [REPEATED_POINTS B_SELECTED SELEC_POINTS INDICES_EXPAND INDICES_ORIGINAL cond_NUMB_WITH cond_NUMB_WITHOUT] = BMATRIXPointsSelection(INDICES_FINAL,INDICES_FINAL_GAUSS,PHI,NMODE_disp,PARAMETER_GREEDY,PHI_EXPANDED,...
...
INDICES_K = [];
GAUSS_POINTS_K =[] ; % Initial set of gauss points
