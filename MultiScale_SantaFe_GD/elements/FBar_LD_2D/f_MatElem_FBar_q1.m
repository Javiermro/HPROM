function [kt,fint,sigma_new,eps_new,eps_fluct,hvar_new,aux_var,m_TensorTang] = ...
   f_MatElem_FBar_q1(u,hvar_old,aux_var,m_VarAuxElem,e_DatElemSet,e_DatMatSet,...
   m_Be,m_DetJe,DefMacro,eps_old,sigma_old,e_VG)
...
hvar_new = f_DefinicionhVar(conshyp,sihvarpg,nPG,e_VG.MOD_TYPE);

% hvar_new = struct(hvar_new,'EPS_ROMI',[],'e_VarEst_ROMII',[],'e_VarAux_ROMII',[]);     % ORIGINAL
