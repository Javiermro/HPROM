function matlab2gid_res(iStep,iStage,in,u,u_old,c_GdlCond,e_DatSet,e_VarEst,e_VarEst_old,e_VarAux,DefMacro,uTotal,ELOC,e_VG)
...
if ~isfield(e_VG,'MOD_TYPE'); MOD_TYPE=0; else MOD_TYPE=e_VG.MOD_TYPE; end
